...
namespace CRS_PRE
{
    ...
    /**********************************************************************/
    public partial class ads007_R04p : Form
    {
        ...
        private void bt_ace_pta_Click(object sender, EventArgs e)
        {
            ...
            // Obtiene Datos
            Tabla = new DataTable();
            Tabla = o_ads007.Fe_inf_R04(tb_usr_ini.Text.Trim(), tb_usr_fin.Text.Trim(), int.Parse(tb_mod_ini.Text), int.Parse(tb_mod_fin.Text));

            // Genera el Informe
            ads007_R04w frm = new ads007_R04w{
