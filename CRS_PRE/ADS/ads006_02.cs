...
namespace CRS_PRE
{
    public partial class ads006_02 : Form
    {
        ...
        protected string Fi_val_dat()
        {
            ...
            {
                tb_cod_tus.Focus();
                return "El Tipo de usuario que desea crear ya se encuentra registrado";
            }
        ...
        private void Bt_ace_pta_Click(object sender, EventArgs e)
        {
                ...
                if (msg_res == DialogResult.OK)
            {
                ...
                MessageBox.Show("Los datos se grabaron correctamente", "Nuevo Tipo de usuario", MessageBoxButtons.OK);
                Fi_lim_pia();
            }
