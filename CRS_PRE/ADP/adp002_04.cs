    ...
    public partial class adp002_04 : Form
    {
        ...
        private void bt_ace_pta_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (frm_dat.Rows[0]["va_est_ado"].ToString() == "H"){
                    msg_res = MessageBox.Show("Está seguro de Deshabilitar a la Persona?", "Deshabilita Persona", MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
                ...
                MessageBox.Show(ex.Message, "Habilita/Deshabilita Persona", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
