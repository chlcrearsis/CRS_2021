...
namespace CRS_PRE
{
    ...
    /*      Opción: Informe R06 - Reporte View                            */
    /*       Autor: JEJR - Crearsis             Fecha: 14-09-2023         */
    /**********************************************************************/
    public partial class ads007_R06w : Form
    {
        ...
        // Variable
        string va_nom_emp = "";
        public string vp_usr_ini;
        public string vp_usr_fin;
        public string vp_nus_ini;
        public string vp_nus_fin;
        public string vp_mod_ini;
        public string vp_mod_fin;
        public string vp_nmo_ini;
        public string vp_nmo_fin;
        ...
        private void frm_Load(object sender, EventArgs e)
        {
            ...
            ads007_R06.SetDatabaseLogon(Program.gl_ide_usr, Program.gl_pas_usr, Program.gl_ser_bdo + "\\" + Program.gl_ins_bdo, Program.gl_nom_bdo);
            // Paso los datos obtenidos del procedimiento en la anterior ventana
            ads007_R06.SetDataSource(frm_dat);
            // Para enviar parametros directos al reporte (nombre del parametro en crystal report, valor que se enviara)
            ads007_R06.SetParameterValue("vc_nom_emp", va_nom_emp);            
            ads007_R06.SetParameterValue("vc_usr_ini", vp_usr_ini);
            ads007_R06.SetParameterValue("vc_nus_ini", vp_nus_ini);
            ads007_R06.SetParameterValue("vc_usr_fin", vp_usr_fin);            
            ads007_R06.SetParameterValue("vc_nus_fin", vp_nus_fin);
            ads007_R06.SetParameterValue("vc_mod_ini", vp_mod_ini);
            ads007_R06.SetParameterValue("vc_nmo_ini", vp_nmo_ini);
            ads007_R06.SetParameterValue("vc_mod_fin", vp_mod_fin);            
            ads007_R06.SetParameterValue("vc_nmo_fin", vp_nmo_fin);
            ads007_R06.SetParameterValue("vc_ide_usr", Program.gl_ide_usr);
        }
