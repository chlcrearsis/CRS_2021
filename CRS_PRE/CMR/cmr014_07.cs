...
namespace CRS_PRE
{
    public partial class cmr014_07 : Form
    {
        ...
        string Titulo = "Comisión Vendedor";
        ...
        protected string Fi_val_dat()
        {
            ...
            if (decimal.Parse(tb_cms_con.Text) < 0m){
                tb_cms_con.Focus();
                return "El porcentaje de comisión al contado DEBE ser MAYOR a CERO";
            }
        ...
        {
            // Valida que el porcentaje comision al contado sea valido
            if (cl_glo_bal.IsDecimal(tb_cms_con.Text) == false)
            {
        ...
        private void cb_tip_com_SelectedValueChanged(object sender, EventArgs e)
        {
            switch (cb_tip_cms.SelectedIndex) {
                case 0: // No Aplica
                    tb_cms_con.Text = "0.0";
                    tb_cms_cre.Text = "0.0";
                    tb_cms_con.Enabled = false;
                    tb_cms_cre.Enabled = false;
                    break;
                case 1: // Ventas Generales
                    tb_cms_con.Text = "0.0";
                    tb_cms_cre.Text = "0.0";
                    tb_cms_con.Enabled = true;
                    tb_cms_cre.Enabled = true;
                    break;
        ...
        private void bt_ace_pta_Click(object sender, EventArgs e)
        {
            ...
            try {                
                ...
                if (msg_res == DialogResult.OK) {
                    ...
                    int tip_cms = cb_tip_cms.SelectedIndex;
                    decimal cms_con = decimal.Parse(tb_cms_con.Text);
                    decimal cms_cre = decimal.Parse(tb_cms_cre.Text);
                    // Actualiza Comision Vendedor
                    o_cmr014.Fe_edi_com(ide_tip, cod_ven, tip_cms, cms_con, cms_cre);
