...
namespace CRS_PRE
{
    public partial class cmr014_04b : Form
    {
        ...
        string Titulo = "Habilita/Deshabilita Cobrador";
        ...
        protected string Fi_val_dat()
        {
            ...
            {
                return "EL Cobrador NO se encuentra registrado";
            }
            ...
            try
            {
                ...
                if (frm_dat.Rows[0]["va_est_ado"].ToString() == "H")
                {
                    ...
                    if (msg_res == DialogResult.OK)
                    {
                        ...
                        o_cmr014.Fe_des_hab(2, int.Parse(tb_cod_cob.Text));
                    }
                }else{
                    ...
                    {
                        // Habilita Cobrador
                        o_cmr014.Fe_hab_ili(2, int.Parse(tb_cod_cob.Text));
                    }
                }
