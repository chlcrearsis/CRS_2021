...
{
    public partial class cmr004_04 : Form
    {
        ...
        private void Bt_ace_pta_Click(object sender, EventArgs e)
        {
            ...
            if(frm_dat.Rows[0]["va_est_ado"].ToString() == "N")
            {
                msg_res = MessageBox.Show("Esta seguro de Habilitar la Plantilla?", "Habilita Plantilla de venta", MessageBoxButtons.OKCancel);
                if (msg_res == DialogResult.OK)
                {
                    o_cmr004.Fe_hab_des(tb_cod_plv.Text,"H");
            ...
            {
                msg_res = MessageBox.Show("Esta seguro de Deshabilitar la Plantilla?", "Deshabilita Plantilla de venta", MessageBoxButtons.OKCancel);
                if (msg_res == DialogResult.OK)
                {
                    o_cmr004.Fe_hab_des(tb_cod_plv.Text, "N");
