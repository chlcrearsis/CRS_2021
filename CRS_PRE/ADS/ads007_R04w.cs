...
namespace CRS_PRE
{
    ...
    /**********************************************************************/
    public partial class ads007_R04w : Form
    {
        ...
        private void frm_Load(object sender, EventArgs e)
        {
            ...
            ads007_R04.SetDatabaseLogon(Program.gl_ide_usr, Program.gl_pas_usr, Program.gl_ser_bdo + "\\" + Program.gl_ins_bdo, Program.gl_nom_bdo);
            // Paso los datos obtenidos del procedimiento en la anterior ventana
            ads007_R04.SetDataSource(frm_dat);
            // Para enviar parametros directos al reporte (nombre del parametro en crystal report, valor que se enviara)
            ads007_R04.SetParameterValue("vc_nom_emp", va_nom_emp);            
            ads007_R04.SetParameterValue("vc_usr_ini", vp_usr_ini);
            ads007_R04.SetParameterValue("vc_nus_ini", vp_nus_ini);
            ads007_R04.SetParameterValue("vc_usr_fin", vp_usr_fin);            
            ads007_R04.SetParameterValue("vc_nus_fin", vp_nus_fin);
            ads007_R04.SetParameterValue("vc_mod_ini", vp_mod_ini);
            ads007_R04.SetParameterValue("vc_nmo_ini", vp_nmo_ini);
            ads007_R04.SetParameterValue("vc_mod_fin", vp_mod_fin);            
            ads007_R04.SetParameterValue("vc_nmo_fin", vp_nmo_fin);
            ads007_R04.SetParameterValue("vc_ide_usr", Program.gl_ide_usr);
        }
