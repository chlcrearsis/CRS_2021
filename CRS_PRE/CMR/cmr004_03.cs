...
namespace CRS_PRE
{
    public partial class cmr004_03 : Form
    {
        ...
        private void Bt_ace_pta_Click(object sender, EventArgs e)
        {
            ...
            if(msg_res== DialogResult.OK)
            {
                ...
                o_cmr004.Fe_edi_tar(tb_cod_plv.Text, tb_nom_plv.Text, tb_des_plv.Text, tb_cod_bod.Text, cam_bod.ToString(), tb_cod_per.Text,
                    ...
                    "VTF", tb_nro_tal_fac.Text, "VTS", tb_nro_tal_nvt.Text, "PED", tb_nro_tal_ped.Text, "COT", tb_nro_tal_cot.Text, "", "0", "", "0",
