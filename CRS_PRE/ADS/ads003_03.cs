...
namespace CRS_PRE
{
    public partial class ads003_03 : Form
    {
        ...
        private void Bt_ace_pta_Click(object sender, EventArgs e)
        {
            ...
            msg_res = MessageBox.Show("Esta seguro de editar la informacion?", "Edita Documento", MessageBoxButtons.OKCancel,MessageBoxIcon.Question);
            if (msg_res == DialogResult.OK)
            {
                //Edita usuario
                o_ads003.Fe_edi_doc(int.Parse(tb_ide_mod.Text),tb_ide_doc.Text, tb_nom_doc.Text, tb_des_doc.Text);
