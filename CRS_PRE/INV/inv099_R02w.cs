...
{
    public partial class inv099_R02w : Form
    {
        ...
        private void frm_Load(object sender, EventArgs e)
        {
            ...
            inv099_R02.SetDatabaseLogon(o_ads013.va_ide_usr, o_ads013.va_pas_usr, o_ads013.va_ser_bda + "\\" + o_ads013.va_ins_bda, o_ads013.va_nom_bda);

            // Paso los datos obtenidos del procedimiento en la anterior ventana
            inv099_R02.SetDataSource(frm_dat);
            // Para enviar parametros directos al reporte (nombre del parametro en crystal report, valor que se enviara)
            inv099_R02.SetParameterValue("vc_ide_usr", o_ads013.va_ide_usr);
            inv099_R02.SetParameterValue("vc_nom_emp", va_nom_emp);

            inv099_R02.SetParameterValue("vc_bod_ini", frm_pad.tb_cod_bo1.Text + " - " + frm_pad.lb_nom_bo1.Text);
            inv099_R02.SetParameterValue("vc_bod_fin", frm_pad.tb_cod_bo2.Text + " - " + frm_pad.lb_nom_bo2.Text);
            inv099_R02.SetParameterValue("vc_fec_exi", frm_pad.tb_fec_exi.Value);
