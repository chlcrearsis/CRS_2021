...
{
    public partial class cmr002_03 : Form
    {
        ...
        protected string Fi_val_dat()
        {
            ...
            {
                tb_cod_pro.Focus();
                return "El producto NO se encuentra registrado en la lista de precio";
            }
            ...
            try
            {
                val = decimal.Parse(tb_pmx_des.Text);
            }
            catch (Exception)
            {
                tb_pmx_des.Focus();
            ...
            {
                tb_pmx_des.Focus();
                return "El % Maximo de descuento para el producto debe ser igual o mayor a cero (0) y menor que cincuenta (50)";
            }
            ...
            try
            {
                val = decimal.Parse(tb_pmx_inc.Text);
            }
            catch (Exception)
            {
                tb_pmx_inc.Focus();
            ...
            {
                tb_pmx_inc.Focus();
                return "El % Maximo de incremento para el producto debe ser igual o mayor a cero (0) y menor que cien (100)";
            }
        ...
        private void Bt_ace_pta_Click(object sender, EventArgs e)
        {
            ...
            {
                //Registrar usuario
                o_cmr002.Fe_edi_pre(int.Parse(tb_nro_lis.Text), tb_cod_pro.Text, decimal.Parse(tb_pre_cio.Text), decimal.Parse(tb_pmx_des.Text), decimal.Parse(tb_pmx_inc.Text));
