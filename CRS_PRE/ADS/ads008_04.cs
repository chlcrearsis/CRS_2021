       ...
       // DataTable tab_res004 = new DataTable();
        ...
        private void frm_Load(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < tab_res004.Rows.Count ; i++)
            {
                ...
                dg_res_ult.Rows[i].Cells["va_per_mis"].Value = o_ads008.Fe_aut_usr(tb_ide_usr.Text, "res004",tab_res004.Rows[i]["va_cod_plv"].ToString());
            }
        }
        ...
        private void Bt_ace_pta_Click(object sender, EventArgs e)
        {
            ...
            if (msg_res == DialogResult.OK)
            {
                for (int i = 0; i < dg_res_ult.RowCount ; i++)
                {
                    ...
                    if (chk_val == true)                    
                        o_ads008.Fe_nue_reg(tb_ide_usr.Text, "res004", cod_plv.ToString());
                    else
                        o_ads008.Fe_eli_min(tb_ide_usr.Text, "res004", cod_plv.ToString());
                }
