...
namespace CRS_PRE
{
    public partial class cmr005_R01w : Form
    {
        ...
        public void Fe_pob_rep()
        {
            ...
            cmr005_R01.SetDatabaseLogon(Program.gl_ide_usr, Program.gl_pas_usr, Program.gl_ser_bdo + "\\" + Program.gl_ins_bdo, Program.gl_nom_bdo);
            ...
            cmr005_R01.SetParameterValue("vc_ide_usr", Program.gl_ide_usr);
            ...
            cmr005_R01.SetParameterValue("vc_fec_fin", frm_pad.tb_fec_fin.Value);
        ...
        public void Fe_imp_doc(string ide_doc, int nro_tal)
        {
            ...
            cmr005_R01.PrintOptions.PrinterName = "PDF24";
            cmr005_R01.PrintToPrinter(1, false, 0, 0);
