    ...
    public partial class ads004_06 : Form
    {
        ...
        private void Bt_ace_pta_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                msg_res = MessageBox.Show("Esta seguro de Eliminar el talonario?", "Elimina Talonario", MessageBoxButtons.OKCancel, MessageBoxIcon.Question);

                if (msg_res == DialogResult.OK)
                {
                   
                   o_ads004.Fe_eli_tal(tb_ide_doc.Text, int.Parse(tb_nro_tal.Text));


                    MessageBox.Show("Los datos se grabaron correctamente", "Elimina Talonario", MessageBoxButtons.OK, MessageBoxIcon.Information);
