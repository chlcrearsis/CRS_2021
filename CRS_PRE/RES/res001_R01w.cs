...
namespace CRS_PRE.CMR
{
    public partial class res001_R01w : Form
    {
        ...
        public void Fe_pob_rep()
        {
            ...
            res001_R01.SetDatabaseLogon(o_ads016.va_ide_usr, o_ads016.va_pas_usr, o_ads016.va_ser_bda + "\\" + o_ads016.va_ins_bda, o_ads016.va_nom_bda);
            // Paso los datos obtenidos del procedimiento en la anterior ventana
            res001_R01.SetDataSource(frm_dat);
            // Para enviar parametros directos al reporte (nombre del parametro en crystal report, valor que se enviara)
            res001_R01.SetParameterValue("vc_ide_usr", o_ads016.va_ide_usr);
            res001_R01.SetParameterValue("vc_nom_emp", va_nom_emp);

            

            res001_R01.SetParameterValue("vc_cod_bod", int.Parse(frm_pad.tb_cod_bod.Text));
            res001_R01.SetParameterValue("vc_nom_bod", frm_pad.lb_nom_bod.Text);
            res001_R01.SetParameterValue("vc_fec_ini", frm_pad.tb_fec_ini.Value);
            res001_R01.SetParameterValue("vc_fec_fin", frm_pad.tb_fec_fin.Value);
            res001_R01.SetParameterValue("vc_est_ado", frm_pad.cb_est_ado.Text);
        ...
        public void Fe_imp_doc(string ide_doc, int nro_tal)
        {
            ...
            res001_R01.PrintOptions.PrinterName = "PDF24";
            res001_R01.PrintToPrinter(1, false, 0, 0);
