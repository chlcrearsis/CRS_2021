...
namespace CRS_PRE
{
    ...
    public partial class ads006_01 : Form
    {
        ...
        public void fi_fil_act()
        {
            if (dg_res_ult.SelectedRows.Count != 0)
            {
                if (dg_res_ult.SelectedRows[0].Cells[0].Value == null){
                    ...
                    tb_ide_tus.Text = dg_res_ult.SelectedRows[0].Cells["va_ide_tus"].Value.ToString();
                    lb_nom_tus.Text = dg_res_ult.SelectedRows[0].Cells["va_nom_tus"].Value.ToString();
                }
            }
        }
        ...
        // Evento Validated: ID. Tipo de Usuario                     
        ...
        // Evento Click: Todos los Tipo de Usuario
