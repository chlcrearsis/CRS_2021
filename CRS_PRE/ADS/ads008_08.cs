...
namespace CRS_PRE
{
    ...
    /*  Aplicación: ads008 - Permiso Usuario de Cobrador                  */
    /* Descripción: Permiso sobre Aplicación                              */
    /*       Autor: JEJR - Crearsis             Fecha: 01-09-2023         */
    /**********************************************************************/
    public partial class ads008_08 : Form
    {
        ...
        private void frm_Load(object sender, EventArgs e)
        {
            ...
            // Obtiene y Desplega Lista de Cobrador
            Tabla = new DataTable();
            Tabla = o_ads008.Fe_usr_cob(tb_ide_usr.Text);
            for (int i = 0; i < Tabla.Rows.Count ; i++)
            {
                dg_res_ult.Rows.Add();
                dg_res_ult.Rows[i].Cells["va_ide_cob"].Value = Tabla.Rows[i]["va_ide_cob"].ToString().Trim();
        ...
        private void bt_ace_pta_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (msg_res == DialogResult.OK)
                {
                    ...
                    o_ads008.Fe_eli_min(tb_ide_usr.Text.Trim(), "cmr014", "2");
                    ...
                    for (int i = 0; i < dg_res_ult.RowCount; i++)
                    {
                        ...
                        if (chk_val == true)
                            o_ads008.Fe_nue_reg(tb_ide_usr.Text.Trim(), "cmr014", "2",  ide_cob);
                    }
