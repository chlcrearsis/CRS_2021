...
namespace CRS_PRE
{
    ...
    /*  Aplicación: ads008 - Permiso Usuario de Lista de Precio           */
    /* Descripción: Permiso sobre Aplicación                              */
    /*       Autor: JEJR - Crearsis             Fecha: 31-08-2023         */
    /**********************************************************************/
    public partial class ads008_04 : Form
    {
        ...
        private void frm_Load(object sender, EventArgs e)
        {
            ...
            Tabla = new DataTable();
            Tabla = o_ads008.Fe_usr_lis(tb_ide_usr.Text);
        ...
        private void bt_ace_pta_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (msg_res == DialogResult.OK)
                {
                    ...
                    o_ads008.Fe_eli_min(tb_ide_usr.Text.Trim(), "cmr001");
                    ...
                    for (int i = 0; i < dg_res_ult.RowCount; i++)
                    {
                        ...
                        if (chk_val == true)
                            o_ads008.Fe_nue_reg(tb_ide_usr.Text.Trim(), "cmr001", cod_lis);
                    }
