        ...
        private void bt_ace_pta_Click(object sender, EventArgs e)
        {
            ...
            try{
                ...
                if (msg_res == DialogResult.OK){
                    ...
                    o_adp006.Fe_reg_ima(int.Parse(tb_cod_per.Text), tb_ide_tip.Text, img_arc, tb_ext_arc.Text, decimal.Parse(tb_tam_arc.Text), tb_ide_usr.Text, fec_reg, tb_nom_equ.Text);
