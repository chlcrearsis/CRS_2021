...
(
	...
	va_fir_ma1	VARCHAR(15)	 NOT NULL DEFAULT(''),	--** Firma Nro. 1
	va_fir_ma2	VARCHAR(15)	 NOT NULL DEFAULT(''),	--** Firma Nro. 2
	va_fir_ma3	VARCHAR(15)	 NOT NULL DEFAULT(''),	--** Firma Nro. 3
	va_fir_ma4	VARCHAR(15)	 NOT NULL DEFAULT(''),	--** Firma Nro. 4
	va_for_log	INT			 NOT NULL DEFAULT(0),	--** Formato de Logo	
												    --** 0=Razon Social de Empresa; 1=Logotipo 1
												    --** 2=Logotipo 2 ;3=Logotipo 3    
    va_obs_uno  VARCHAR(80)  NOT NULL DEFAULT(''),  --** Observación 1
	va_obs_dos  VARCHAR(80)  NOT NULL DEFAULT(''),  --** Observación 2
