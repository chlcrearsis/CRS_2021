...
{
    public partial class inv004_03b : Form
    {
        ...
        private void frm_Load(object sender, EventArgs e)
        {
            ...
            //** Datos vademecum
            tb_pri_act.Text = frm_dat.Rows[0]["va_pri_act"].ToString();
            tb_pro_ind.Text = frm_dat.Rows[0]["va_pro_ind"].ToString();
            tb_con_ind.Text = frm_dat.Rows[0]["va_con_ind"].ToString();
        ...
        protected string Fi_val_dat()
        {
           ...
           if (tb_cod_fam.Text == "000000" || tb_cod_fam.Text=="")
            ...
            {
                tb_nom_pro.Focus();
                return "Debe proporcionar el nombre comercial del producto";
            }
        ...
        /// <summary>
        /// Obtiene ide y nombre Marca para colocar en los campos del formulario
        /// </summary>
        void Fi_obt_mar()
        {
            int val = 0;
        ...
        private void Bt_ace_pta_Click(object sender, EventArgs e)
        {
            ...
            msg_res = MessageBox.Show("Esta seguro de Editar la informacion?", "Edita Producto", MessageBoxButtons.OKCancel);
            if (msg_res == DialogResult.OK)
            {
                //Edita Producto
                o_inv004.Fe_edi_proB(tb_cod_pro.Text, int.Parse(tb_cod_mar.Text), tb_nom_pro.Text.Trim(), tb_des_pro.Text.Trim(), 
                    tb_cod_bar.Text.Trim(), tb_fab_ric.Text.Trim(), int.Parse(tb_nro_dec.Text),tb_pri_act.Text,tb_pro_ind.Text,tb_con_ind.Text );

                //MessageBox.Show("Los datos se Editaron correctamente", "Edita Producto", MessageBoxButtons.OK);
