...
namespace CRS_PRE
{
    public partial class adp014_R01w : Form
    {
        ...
        private void frm_Load(object sender, EventArgs e)
        {
            ...
            if (vp_ord_dat.CompareTo("T") == 0)
                vp_ord_dat = "Tipo Documento";
            if (vp_ord_dat.CompareTo("D") == 0)
                vp_ord_dat = "Descripción";
            ...
            adp014_R01.SetDatabaseLogon(o_ads007.va_ide_usr, o_ads007.va_pas_usr, o_ads007.va_ser_bda + "\\" + o_ads007.va_ins_bda, o_ads007.va_nom_bda);
            // Paso los datos obtenidos del procedimiento en la anterior ventana
            adp014_R01.SetDataSource(frm_dat);
            // Para enviar parametros directos al reporte (nombre del parametro en crystal report, valor que se enviara)
            adp014_R01.SetParameterValue("vc_nom_emp", va_nom_emp);
            adp014_R01.SetParameterValue("vc_est_ado", vp_est_ado);
            adp014_R01.SetParameterValue("vc_ord_dat", vp_ord_dat);
            adp014_R01.SetParameterValue("vc_ide_usr", o_ads007.va_ide_usr);                       
