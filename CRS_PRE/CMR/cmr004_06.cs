...
namespace CRS_PRE
{
    public partial class cmr004_06 : Form
    {
        ...
        private void Bt_ace_pta_Click(object sender, EventArgs e)
        {
            ...
            if (msg_val != "")
            {
                ...
                msg_res = MessageBox.Show("Esta seguro de Eliminar la Plantilla?", "Elimina Plantilla de venta", MessageBoxButtons.OKCancel);
                if (msg_res == DialogResult.OK)
                {
                    o_cmr004.Fe_eli_min(tb_cod_plv.Text );
