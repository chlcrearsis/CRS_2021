...
namespace CRS_PRE
{
    public partial class ads008_03b : Form
    {
        ...
        private void frm_Load(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < tab_cmr004.Rows.Count ; i++)
            {
                ...
                dg_res_ult.Rows[i].Cells["va_per_mis"].Value = o_ads009.Fe_ads009_02(tb_ide_usr.Text,"cmr004", tab_cmr004.Rows[i]["va_cod_plv"].ToString() );
            }
        }
        ...
        private void Bt_ace_pta_Click(object sender, EventArgs e)
        {
            ...
            if (msg_res == DialogResult.OK)
            {
                for (int i = 0; i < dg_res_ult.RowCount ; i++)
                {
                    ...
                    if (chk_val == true)
                    {
                        o_ads009.Fe_ads009_04(tb_ide_usr.Text, "cmr004", cod_plv.ToString());
                        o_ads009.Fe_ads009_03(tb_ide_usr.Text, "cmr004", cod_plv.ToString());
                    }
                    if (chk_val == false)
                        o_ads009.Fe_ads009_04(tb_ide_usr.Text, "cmr004", cod_plv.ToString());
                }
