...
namespace CRS_PRE
{
    ...
    /*  Aplicación: ads008 - Permiso Usuario de Grupo de Bodega           */
    /* Descripción: Permiso sobre Aplicación                              */
    /*       Autor: JEJR - Crearsis             Fecha: 07-09-2023         */
    /**********************************************************************/
    public partial class ads008_09 : Form
    {
        ...
        private void bt_ace_pta_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (msg_res == DialogResult.OK)
                {
                    ...
                    o_ads008.Fe_eli_min(tb_ide_usr.Text.Trim(), "inv001");
                    ...
                    for (int i = 0; i < dg_res_ult.RowCount; i++)
                    {
                        ...
                        if (chk_val == true)
                            o_ads008.Fe_nue_reg(tb_ide_usr.Text.Trim(), "inv001", ide_gru);
                    }
