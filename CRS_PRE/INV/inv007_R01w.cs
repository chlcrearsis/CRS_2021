...
{
    public partial class inv007_R01w : Form
    {
        ...
        private void frm_Load(object sender, EventArgs e)
        {
            ...
            inv007_R01.SetParameterValue("vc_bod_fin", frm_pad.tb_cod_bo2.Text + " - " + frm_pad.lb_nom_bo2.Text);

            inv007_R01.SetParameterValue("vc_per_ini", frm_pad.tb_cod_pe1.Text + " - " + frm_pad.lb_nom_pe1.Text);
            inv007_R01.SetParameterValue("vc_per_fin", frm_pad.tb_cod_pe2.Text + " - " + frm_pad.lb_nom_pe2.Text);

            inv007_R01.SetParameterValue("vc_fec_ini", frm_pad.tb_fec_ini.Value);
            inv007_R01.SetParameterValue("vc_fec_fin", frm_pad.tb_fec_fin.Value);

            inv007_R01.SetParameterValue("vc_est_ado", "(Todos)");
