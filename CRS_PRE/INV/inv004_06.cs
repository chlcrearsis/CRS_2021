...
{
    public partial class inv004_06 : Form
    {
        ...
        private void Bt_ace_pta_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                msg_res = MessageBox.Show("Esta seguro de Eliminar la informacion?", "Producto", MessageBoxButtons.OKCancel);
                if (msg_res == DialogResult.OK)
                {
                    o_inv004.Fe_eli_pro(tb_cod_pro.Text.Trim());
            ...
            {
                MessageBox.Show(Ex.Message, "Producto", MessageBoxButtons.OK,MessageBoxIcon.Warning);
            }
