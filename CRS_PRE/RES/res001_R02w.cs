...
namespace CRS_PRE.CMR
{
    public partial class res001_R02w : Form
    {
        ...
        public void Fe_pob_rep()
        {
            ...
            res001_R02.SetParameterValue("vc_cod_bod", int.Parse(frm_pad.tb_cod_bod.Text));
            res001_R02.SetParameterValue("vc_nom_bod", frm_pad.lb_nom_bod.Text);
            res001_R02.SetParameterValue("vc_fec_ini", frm_pad.tb_fec_ini.Value);
            res001_R02.SetParameterValue("vc_fec_fin", frm_pad.tb_fec_fin.Value);
        ...
        public void Fe_imp_doc(string ide_doc, int nro_tal)
        {
            ...
            res001_R02.PrintOptions.PrinterName = "PDF24";
            res001_R02.PrintToPrinter(1, false, 0, 0);
