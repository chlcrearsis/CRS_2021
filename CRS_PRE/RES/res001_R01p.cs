...
namespace CRS_PRE
{
    public partial class res001_R01p : Form
    {
        ...
        private void Bt_ace_pta_Click(object sender, EventArgs e)
        {
            ...
            tabla = o_res001.Fe_res001_R01(int.Parse(tb_cod_bod.Text),tb_fec_ini.Value,tb_fec_fin.Value, va_est_ado);

            res001_R01w frm = new res001_R01w();
