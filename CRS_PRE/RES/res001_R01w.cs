...
namespace CRS_PRE
{
    public partial class res001_R01w : Form
    {
        ...
        public void Fe_pob_rep()
        {
            ...
            res001_R01.SetDatabaseLogon(Program.gl_ide_usr, Program.gl_pas_usr, Program.gl_ser_bdo + "\\" + Program.gl_ins_bdo, Program.gl_nom_bdo);
            ...
            res001_R01.SetParameterValue("vc_ide_usr", Program.gl_ide_usr);
