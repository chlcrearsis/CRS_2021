...
namespace CRS_NEG
{
    ...
    public class cmr004
    {
        ...
        /// <param name="mon_vta">Moneda de la venta (B=Bolivianos; U= Dolares)</param>
        /// <param name="cam_mon">cambia moneda ? ( 0=NO; 1=CAMBIA; 2=Obtiene moneda de la lista fija)</param>
        ...
        /// <param name="des_srv">Permite escribir descripcion en productos de servicio ? (0=NO; 1=SI)</param>
        /// <param name="pro_rep">Permite productos repetidos ? (0=NO; 1=SI)</param>
        ...
        /// <param name="doc_ped">Documento Pedido (adm003) (3 Letras)</param>
        /// <param name="tal_ped">Talonario Pedido (adm004) (2 numeros)</param>
        /// <param name="doc_cot">Documento Cotizacion (adm003) (3 Letras)</param>
        /// <param name="tal_cot">Talonario Cotizacion (adm004) (2 numeros)</param>
        ...
        /// <param name="imp_ped">Impresora para pedido</param>
        /// <param name="imp_cot">Impresora para cotizacion</param>
        ...
        public void Fe_nue_reg(string cod_plv, string nom_plv, string des_plv, string cod_bod, string cam_bod, string cod_cli, string cod_caj, string cam_caj,
                        ...
                        string doc_dcf, string tal_dcf, string doc_dsf, string tal_dsf, string imp_fac, string imp_ntv, string imp_ped, string imp_cot,
                        string imp_dcf, string imp_dsf, string ban_av1, string imp_av1, string ban_av2, string imp_av2, string ban_imp)
        {
            try
            {
                ...
                cadena.AppendFormat("'{0}','{1}','{2}','{3}','{4}','{5}','{6}','{7}',", doc_fac, tal_fac, doc_ntv, tal_ntv, doc_ped, tal_ped, doc_cot, tal_cot);
                cadena.AppendFormat("'{0}','{1}','{2}','{3}','{4}','{5}','{6}','{7}',", doc_dcf, tal_dcf, doc_dsf, tal_dsf, imp_fac, imp_ntv, imp_ped, imp_cot);
                cadena.AppendFormat("'{0}','{1}','{2}','{3}','{4}','{5}','{6}','H')", imp_dcf, imp_dsf, ban_av1, imp_av1, ban_av2, imp_av2, ban_imp);
                        ...
                        string imp_dcf, string imp_dsf, string ban_av1, string imp_av1, string ban_av2, string imp_av2, string ban_imp)
        {
            try
            {
                ...
                cadena.AppendFormat("va_doc_ped='{0}',va_tal_ped={1},va_doc_cot='{2}',va_tal_cot={3},va_ban_imp={4},va_imp_fac='{5}',", doc_ped, tal_ped, doc_cot, tal_cot, ban_imp, imp_fac);
                cadena.AppendFormat("va_imp_ntv='{0}',va_imp_ped='{1}',va_imp_cot='{2}',va_ban_av1={3},va_imp_av1='{4}',va_ban_av2={5},", imp_ntv, imp_ped, imp_cot, ban_av1, imp_av1, ban_av2);
                cadena.AppendFormat("va_imp_av2='{0}',va_bus_pro={1},va_des_srv={2},va_pro_rep='{3}',va_cam_caj={4},va_doc_dcf='{5}',", imp_av2, bus_pro, des_srv, pro_rep, cam_caj, doc_dcf);
