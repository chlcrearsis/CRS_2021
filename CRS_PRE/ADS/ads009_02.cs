...
namespace CRS_PRE
{
    ...
    /*  Aplicación: ads009 - Permiso Tipo Usuario de Talonario            */
    /* Descripción: Permiso sobre Aplicación                              */
    /*       Autor: JEJR - Crearsis             Fecha: 30-08-2023         */
    /**********************************************************************/
    public partial class ads009_02 : Form
    {
        ...
        private void Fi_des_tal() {
            ...
            Tabla = new DataTable();
            Tabla = o_ads009.Fe_tus_tal(int.Parse(tb_ide_tus.Text), vp_ide_mod);
        ...
        private void bt_ace_pta_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (msg_res == DialogResult.OK)
                {
                    ...
                    o_ads009.Fe_eli_min(int.Parse(tb_ide_tus.Text.Trim()), "ads004");
                    ...
                    for (int i = 0; i < dg_res_ult.RowCount; i++)
                    {
                        ...
                        if (chk_val == true)
                            o_ads009.Fe_nue_reg(int.Parse(tb_ide_tus.Text.Trim()), "ads004", ide_doc, nro_tal);
                    }
