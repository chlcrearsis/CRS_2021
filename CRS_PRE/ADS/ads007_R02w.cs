...
namespace CRS_PRE
{
    ...
    /**********************************************************************/
    public partial class ads007_R02w : Form
    {
        ...
        // Variable
        string va_nom_emp = "";
        public string vp_tus_ini;
        public string vp_tus_fin;
        ...
        private void frm_Load(object sender, EventArgs e)
        {
            ...
            ads007_R02.SetDatabaseLogon(Program.gl_ide_usr, Program.gl_pas_usr, Program.gl_ser_bdo + "\\" + Program.gl_ins_bdo, Program.gl_nom_bdo);
            // Paso los datos obtenidos del procedimiento en la anterior ventana
            ads007_R02.SetDataSource(frm_dat);
            // Para enviar parametros directos al reporte (nombre del parametro en crystal report, valor que se enviara)
            ads007_R02.SetParameterValue("vc_nom_emp", va_nom_emp);
