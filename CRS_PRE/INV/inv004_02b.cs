...
{
    public partial class inv004_02b : Form
    {
        ...
        private void Bt_ace_pta_Click(object sender, EventArgs e)
        {
            ...
            if (msg_res == DialogResult.OK)
            {
                ...
                //Registrar Producto
                o_inv004.Fe_creaB(tb_cod_pro.Text.Trim(), tb_cod_fam.Text, tb_und_med.Text, tb_und_cmp.Text, tb_und_vta.Text, int.Parse(tb_cod_mar.Text), tb_nom_pro.Text.Trim(),
                    ...
                    tb_pri_act.Text,tb_pro_ind.Text,tb_con_ind.Text);
