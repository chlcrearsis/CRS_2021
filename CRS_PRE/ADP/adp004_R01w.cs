...
namespace CRS_PRE
{
    ...
    public partial class adp004_R01w : Form
    {
        ...
        private void frm_Load(object sender, EventArgs e)
        {
            ...
            adp004_R01.SetDatabaseLogon(Program.gl_ide_usr, Program.gl_pas_usr, Program.gl_ser_bdo + "\\" + Program.gl_ins_bdo, Program.gl_nom_bdo);
            ...
            adp004_R01.SetParameterValue("vc_ide_usr", Program.gl_ide_usr);
        }
