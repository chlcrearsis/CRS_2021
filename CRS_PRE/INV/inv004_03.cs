...
{
    public partial class inv004_03 : Form
    {
        ...
        private void Bt_ace_pta_Click(object sender, EventArgs e)
        {
            ...
            {
                //Edita Producto
                o_inv004.Fe_edi_pro(tb_cod_pro.Text, int.Parse(tb_cod_mar.Text), tb_nom_pro.Text.Trim(), tb_des_pro.Text.Trim(), 
                    tb_cod_bar.Text.Trim(), tb_fab_ric.Text.Trim(), int.Parse(tb_nro_dec.Text));
