...
namespace CRS_PRE
{
    public partial class res004_05 : Form
    {
        ...
        void Fi_ini_frm()
        {
            ...
            tb_cod_doc_cot.Text = frm_dat.Rows[0]["va_doc_con"].ToString();
            tb_nro_tal_cot.Text = frm_dat.Rows[0]["va_tal_con"].ToString();
            tb_imp_cot.Text = frm_dat.Rows[0]["va_imp_con"].ToString();
