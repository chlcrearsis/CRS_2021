...
namespace CRS_PRE
{
    ...
    public partial class adp018_R01w : Form
    {
        ...
        private void frm_Load(object sender, EventArgs e)
        {
            ...
            // Castea la bandera facturacion
            if (vp_ban_fac.CompareTo("0") == 0)
                vp_ban_fac = "Registro Cliente";
            if (vp_ban_fac.CompareTo("1") == 0)
                vp_ban_fac = "Grupo Empresarial";
            if (vp_ban_fac.CompareTo("1") == 0)
                vp_ban_fac = "Todos";
            ...
            adp018_R01.SetDatabaseLogon(Program.gl_ide_usr, Program.gl_pas_usr, Program.gl_ser_bdo + "\\" + Program.gl_ins_bdo, Program.gl_nom_bdo);

            // Paso los datos obtenidos del procedimiento en la anterior ventana
            adp018_R01.SetDataSource(frm_dat);
            ...
            adp018_R01.SetParameterValue("vc_ide_usr", Program.gl_ide_usr);
        }
