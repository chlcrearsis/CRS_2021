...
namespace CRS_PRE
{
    ...
    /*      Opción: Informe R06 - Parametros                              */
    /*       Autor: JEJR - Crearsis             Fecha: 14-09-2023         */
    /**********************************************************************/
    public partial class ads007_R06p : Form
    {
        ...
        private void bt_ace_pta_Click(object sender, EventArgs e)
        {
            ...
            // Obtiene Datos
            Tabla = new DataTable();
            Tabla = o_ads007.Fe_inf_R06(tb_usr_ini.Text.Trim(), tb_usr_fin.Text.Trim(), int.Parse(tb_mod_ini.Text), int.Parse(tb_mod_fin.Text));

            // Genera el Informe
            ads007_R06w frm = new ads007_R06w{
