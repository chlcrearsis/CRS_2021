...
{
    public partial class inv005_03 : Form
    {
        ...
        private void bt_ace_pta_Click(object sender, EventArgs e)
        {
            ...
            msg_res = MessageBox.Show("Esta seguro de Editar la informacion?", "Edita Unidad", MessageBoxButtons.OKCancel);
            if (msg_res == DialogResult.OK)
            {
                //Registrar
                o_inv005.Fe_edi_umd(tb_cod_umd.Text,tb_nom_umd.Text);
