...
namespace CRS_PRE
{
    ...
    /**********************************************************************/
    public partial class adp002_06 : Form
    {
        ...
        /// <summary>
        /// Metodo : Valida datos de la persona
        /// </summary>
        /// <returns></returns>
        protected string Fi_val_dat()
        {
            // Verificar SI la Persona se encuentra registrada
            Tabla = new DataTable();
            ...
            // Verifica Si la persona esta Deshabilitada
        ...
        private void bt_ace_pta_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                msg_res = MessageBox.Show("Está seguro de Eliminar a la Persona?", "Elimina Persona", MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
                ...
                MessageBox.Show(ex.Message, "Elimina Persona", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
