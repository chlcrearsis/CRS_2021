...
namespace CRS_PRE
{
    ...
    /*  Aplicación: ads009 - Permiso Tipo Usuario de Plantilla de Venta */
    /* Descripción: Permiso sobre Aplicación                            */
    /*       Autor: JEJR - Crearsis             Fecha: 31-08-2023       */
    /********************************************************************/
    public partial class ads009_03 : Form
    {
        ...
        private void frm_Load(object sender, EventArgs e)
        {
            ...
            Tabla = new DataTable();
            Tabla = o_ads009.Fe_tus_pdv(int.Parse(tb_ide_tus.Text.Trim()));
        ...
        private void bt_ace_pta_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (msg_res == DialogResult.OK)
                {
                    ...
                    o_ads009.Fe_eli_min(int.Parse(tb_ide_tus.Text.Trim()), "cmr004");
                    ...
                    for (int i = 0; i < dg_res_ult.RowCount; i++)
                    {
                        ...
                        if (chk_val == true)
                            o_ads009.Fe_nue_reg(int.Parse(tb_ide_tus.Text.Trim()), "cmr004", cod_pdv);
                    }
