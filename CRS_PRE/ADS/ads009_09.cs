...
namespace CRS_PRE
{
    ...
    /*  Aplicación: ads008 - Permiso Tipo Usuario de Grupo de Bodega      */
    /* Descripción: Permiso sobre Aplicación                              */
    /*       Autor: JEJR - Crearsis             Fecha: 07-09-2023         */
    /**********************************************************************/
    public partial class ads009_09 : Form
    {
        ...
        private void frm_Load(object sender, EventArgs e)
        {
            ...
            Tabla = new DataTable();
            Tabla = o_ads009.Fe_tus_gdb(int.Parse(tb_ide_tus.Text.Trim()));
        ...
        private void bt_ace_pta_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (msg_res == DialogResult.OK)
                {
                    ...
                    o_ads009.Fe_eli_min(int.Parse(tb_ide_tus.Text.Trim()), "inv001");
                    ...
                    for (int i = 0; i < dg_res_ult.RowCount; i++)
                    {
                        ...
                        if (chk_val == true)
                            o_ads009.Fe_nue_reg(int.Parse(tb_ide_tus.Text.Trim()), "inv001", ide_gru);
                    }
