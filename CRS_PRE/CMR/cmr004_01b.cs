...
{
    public partial class cmr004_01b : Form
    {
        ...
        private void fi_bus_car(string ar_tex_bus = "", int ar_prm_bus = 0, string ar_est_bus = "T")
        {
            ...
            tabla = o_cmr004.Fe_bus_car_permiso(ar_tex_bus, ar_prm_bus, ar_est_bus);
        ...
        private void fi_con_sel()
        {
            ...
            tabla = o_cmr004.Fe_con_plv(tb_sel_bus.Text);
        ...
        {
            string res_fun = "";
            tab_dat = o_cmr004.Fe_con_plv(sel_ecc.ToString());
            if (tabla.Rows.Count == 0)
            {
